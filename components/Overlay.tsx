                    ...
                    <div className="flex flex-col items-center">
                        ...
                        <div className="flex items-center gap-4 pointer-events-auto">
                            <a
                                ...
                                className="flex items-center gap-2 px-6 py-3 rounded-full bg-white/10 hover:bg-white/20 border border-white/5 backdrop-blur-sm transition-all hover:scale-105 text-white font-medium"
                            >
                            ...
                            <a
                                ...
                                target="_blank"
                                rel="noopener noreferrer"
                                className="flex items-center gap-2 px-6 py-3 rounded-full bg-[#0077b5]/20 hover:bg-[#0077b5]/40 border border-[#0077b5]/50 backdrop-blur-sm transition-all hover:scale-105 text-white font-medium"
                            >
