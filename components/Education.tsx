...
export default function Education() {
    return (
        <section id="education" className="bg-transparent px-4 sm:px-6 md:px-8 py-16 md:py-24 relative z-20 flex flex-col items-center">
            ...
            <div className="max-w-4xl mx-auto w-full">
                <motion.h2
                    ...
                    className="text-3xl sm:text-4xl md:text-5xl font-bold text-white mb-10 md:mb-16 tracking-tight text-center"
                >
                    Education
                </motion.h2>
                ...
                <div className="space-y-12">
                    {education.map((edu, index) => (
                        <motion.div
                            ...
                            className="relative pl-6 sm:pl-8 border-l-2 border-white/10"
                        >
                            <div className="absolute -left-[9px] top-0 w-4 h-4 rounded-full bg-blue-500 shadow-[0_0_10px_rgba(59,130,246,0.5)]" />

                            <div className="mb-6">
                                <h3 className="text-xl sm:text-2xl md:text-3xl font-bold text-white mb-2">{edu.institution}</h3>
                                <div className="flex flex-wrap items-center gap-x-3 gap-y-1 text-gray-400 font-mono text-xs sm:text-sm">
                            ...
                            <ul className="space-y-3 sm:space-y-4">
                                {edu.details.map((detail, i) => (
                                    <motion.li
                                        ...
                                        className="text-sm sm:text-base text-gray-300 leading-relaxed flex items-start gap-2 sm:gap-3"
                                    >
